...
export const WebsiteProductsList = () => {
  return (
...
export const WebsiteProductEdit = () => {
  ...
  <Edit>
    ...
    <SimpleForm>
      ...
      {/* <TextInput source="" />
      <ArrayInput source="trademark" label="Trademark">
        <SimpleFormIterator inline>
          <ImageField source="logo" helperText={false} />
          <TextInput source="name" label="Brand"/>
          <TextInput source="website" />
        </SimpleFormIterator>
      </ArrayInput> */}
      {/* <DateField source="updatedAt" label="Last modified on" /> */}
      <TextInput source="type" lable="Type"/>
      <NumberInput source="msrp" />
      <TextInput source="ean" />
      <NumberInput source="width" />
      <NumberInput source="length" />
      <NumberInput source="weight" />
      <RichTextInput source="descriptionHTML" label="Specifications"/>
