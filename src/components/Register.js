    ...
    const sortbyMulti = [
        {
            ...
            options: [
                ...
                { label: "Files Delete", value: "Files-Delete" },
                { label: "Files Admin", value: "Files-Admin" }
            ]
        },
        {
            label: "Products",
        ...
        },
        {
            label: "Trademarks",
            options: [
                { label: "Trademarks Read", value: "Trademarks-Read" },
                { label: "Trademarks Write", value: "Trademarks-Write" },
                { label: "Trademarks Delete", value: "Trademarks-Delete" },
                { label: "Trademarks Admin", value: "Trademarks-Admin" }
            ]
        }
                                ...
                                <Card className="mt-4">
                                    ...
                                    <CardBody className="p-4">
                                        <div className="text-center mt-2">
                                            ...
                                            {/* <p className="text-muted">Here you can select the roles for a </p> */}
                                        </div>
                                        <div className="p-2 mt-4">
                                            <form className="needs-validation" action="#">
                                                ...
                                                <Col width="100">
                                                    <h6 className="fw-semibold">Roles</h6>
