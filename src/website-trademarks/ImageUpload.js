...
export const ImageUpload = () => {
    ...
    const getImageId = () => {
        const product_id = window.location.pathname.split('/website-trademarks/list/')[1];
    ...
    //     setFiles(image_list);
        ...
        setUrl("http://192.168.1.63:8000/website-trademarks/upload-image/" + product_id + "/");
        // console.log(url);
    }
    ...
    server={url}
    // instantUpload={false}
    labelFileProcessingComplete="Image(s) have been added to the website :)"
    labelFileProcessingError="Either an image already exists with that name or David messed up"
    FileProcessingError="Either an image with this name already exists or David messed up"
